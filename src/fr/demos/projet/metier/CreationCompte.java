...
public class CreationCompte {
	...
	public Compte creationCompte(String nom, String prenom, String mail, String pwd, String pwdConfirm, String adrLiv, String adrFact) {
		Compte compte = null;
	...
	private void validationMotsDePasse( String motDePasse, String confirmation ) throws UtilisateurException {
	    if ( motDePasse != null && confirmation != null && motDePasse != "" && confirmation != "") {
	        if ( !motDePasse.equals( confirmation ) ) {
	            throw new UtilisateurException( "Les mots de passe entrés sont différents, merci de les saisir à nouveau." );
	        } else if ( motDePasse.length() < 3 ) {
	            throw new UtilisateurException( "Les mots de passe doivent contenir au moins 3 caractères." );
	        }
	    } else {	    	
	...
	private void champsNonRempli( String nom, String prenom, String mail, String pwd, String pwdConfirm, String adrLiv, String adrFact ) throws UtilisateurException {
